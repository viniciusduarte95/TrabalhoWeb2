      ...
      <nav class='top-section navbar'>
        ...
        <div class="container">
            <div class="row align-items-start">
              ...
              <a href="${pageContext.request.contextPath}/ProdutoController?action=formProduto">
                ...
                <tbody>
                    <c:forEach var="produto" items="${listaProdutos}">  
                        <tr>
                            ...
                            <td>
                               <a class="btn btn-info" href="${pageContext.request.contextPath}/ProdutoController?action=show&idProduto=${produto.idProduto}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                        <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
                                        <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
                                    </svg>
                                </a>
                                <a class="btn btn-success"  href="${pageContext.request.contextPath}/ProdutoController?action=formProduto&idProduto=${produto.idProduto}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                                        <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z"/>
                                    </svg>
                                </a>
                                <a class="btn btn-danger" href="${pageContext.request.contextPath}/ProdutoController?action=delete&idProduto=${produto.idProduto}" onclick="return confirm('Confirma a exclusão da categoria ${produto.nome}?')">
