                    ...
                    <div class="col-sm">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="${pageContext.request.contextPath}/GeradorRelatorioController?action=relatorioFuncionarios" target="_blank" class="btn btn-success btn-lg btn-block">Exportar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="${pageContext.request.contextPath}/GeradorRelatorioController?action=relatorioReclamacoes" target="_blank" class="btn btn-success btn-lg btn-block">Exportar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="${pageContext.request.contextPath}/GeradorRelatorioController?action=relatorioMaisReclamados" target="_blank" class="btn btn-success btn-lg btn-block">Exportar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="${pageContext.request.contextPath}/GeradorRelatorioController?action=relatorioAtendimentosAbertos" target="_blank" class="btn btn-success btn-lg btn-block">Exportar</a>
                            </div>
                        </div>
                    </div>
                </div>
